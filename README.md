...
_TODO delete this line. **Note**: The following image link needs to be updated. Replace `diagram_filename.png` with the name of your diagram image file.  
...
Load balancing ensures that the application will be highly , in addition to restricting _____ to the network.
